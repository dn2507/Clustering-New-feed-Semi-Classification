...
public class StopWords {
	...
	public boolean StopWord(List<String> stpwrds, String u) {
		boolean b = false;
	...
	public static List<String> list = new ArrayList<>(Arrays.asList("'s", "a", "able",
			...
			"its", "itself", "just", "k", "keep", "keeps", "kept", "know",
			"knows", "known", "last", "lately", "later", "latter",
			...
			"themselves", "then", "thence", "there", "there's","ß","á","ï","è","î",
			"z","b","pr","ª","y","u","ô","ê","ù","db","û","b","ø","ü","ë","ù","éz",
			"å","ýë","ò","ä","ó","ê","ù","ë","î","ü","ä","þ","pz","ýð","îlhã","pc","y",
			"b","îã","aö","àè","wë","åzf","ønit","ëù","z","º","yè","dh","üa","ha","ar",
			"t","d","ñ","i","m","w","o","à","g","v","í","ð","ú","c","é","x","ÿ","t","ã",
			"æ","g","µ","f","ö","p","e","j","i","æ","ñ","q","h","ñ","p","ý","r","ç","â","j","ý","r","ì","l","n",
			...
			"would", "wouldn't", "yes", "yet", "you", "you'd", "you'll",
