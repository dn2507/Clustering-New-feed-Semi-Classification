...
public class Stemmer {
		...
		//this method helps in calling the Stemmer class. 
		
		public String StemmerCall(String word, Stemmer s) {
			for (int c = 0; c < word.length(); c++) {
				s.add(word.charAt(c));                       // Add chars to word upon space and stem the word
			}
			s.stem(); 										 // String processWord(String word);
			String u = s.toString();
			return u;
		}
